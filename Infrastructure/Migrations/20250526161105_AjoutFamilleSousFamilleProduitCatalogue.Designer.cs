...
namespace GestionCollectes.Migrations
{
    ...
    [Migration("20250526161105_AjoutFamilleSousFamilleProduitCatalogue")]
    partial class AjoutFamilleSousFamilleProduitCatalogue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionCollectes.Domain.Entities.Famille", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GestionCollectes.Domain.Entities.ProduitCatalogue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProduitsCatalogue");
                });

            modelBuilder.Entity("GestionCollectes.Domain.Entities.SousFamille", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Nom", "FamilleId")
                        .IsUnique();

                    b.ToTable("SousFamilles");
                });
            ...
            modelBuilder.Entity("GestionCollectes.Domain.Entities.ProduitCatalogue", b =>
                {
                    b.HasOne("GestionCollectes.Domain.Entities.Famille", "Famille")
                        .WithMany()
                        .HasForeignKey("FamilleId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GestionCollectes.Domain.Entities.SousFamille", "SousFamille")
                        .WithMany("Produits")
